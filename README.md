...
The Data Specification on Energy Resources – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Energy Resources.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Energy Resources](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-gml) | INSPIRE spatial data set encoded in GML, Energy Resources features |
| [Application Schema, Energy Resources Base](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-as) | INSPIRE spatial data set |
| [Application Schema, Energy Resources Coverage](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-c-as) | INSPIRE spatial data set |
| [Application Schema, Energy Resources Vector](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-v-as) | INSPIRE spatial data set |
| [Reference Systems, Energy Resources](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-rs) | INSPIRE spatial data set |
| [Data Consistency, Energy Resources](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-dc) | INSPIRE spatial data set |
| [Information Accessibility, Energy Resources](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-ia) | INSPIRE spatial data set |
| [Portrayal, Energy Resources](http://inspire.ec.europa.eu/id/ats/data-er/3.0/er-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Energy Resources - Core", are not needed as no feature instance can be of a type from that application schema.
