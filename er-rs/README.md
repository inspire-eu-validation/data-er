# Conformance class: Reference systems, Energy Resources
...
| ------------- | ----------------- | ---------------- | ---------- |
| [TG DS-ER](#ref_TG_DS_ER) | [GML application schema, Energy Resources](../er-gml/README.md) | INSPIRE spatial data set encoded in GML, Energy Resources features | n/a |
...
-------------------------------- | --------------------------------------------------
TG DS-ER <a name="ref_TG_DS_ER"></a>   | [INSPIRE Data Specification on Energy Resources – Technical Guidelines version 3.2](http://inspire.ec.europa.eu/documents/Data_Specifications/INSPIRE_DataSpecification_ER_v3.0.pdf)
