...
* Validate each document against the latest INSPIRE official schema(s), using strict XML schema validation. 
  ...
  *  Energy Resources Coverage: https://inspire.ec.europa.eu/schemas/er-c/4.0/EnergyResourcesCoverage.xsd
  *  Energy Resources Vector: https://inspire.ec.europa.eu/schemas/er-v/4.0/EnergyResourcesVector.xsd
