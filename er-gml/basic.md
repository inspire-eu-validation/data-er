...
**Purpose**: Verify that the spatial data set contains at least one Energy Resources feature.
...
* [TG DS-ER](./README.md#ref_TG_DS_ER) 5.4, 5.5
...
----------------------------------------------------- | ------------------------------------------------------------------
features <a name="features"></a>   |  //schema-element(er-v:FossilFuelResource) \| //schema-element(er-v:RenewableAndWasteResource) \| //schema-element(er-c:RenewableAndWastePotentialCoverage)